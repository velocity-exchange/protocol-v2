...
export const mockPerpMarkets: Array<PerpMarketAccount> = [
	{
		...
		feeAdjustment: 0,
		pausedOperations: 0,
		paddingFormerFuelBoostPosition: 0,
		paddingFormerFuelBoostMaker: 0,
		paddingFormerFuelBoostTaker: 0,
...
export const mockSpotMarkets: Array<SpotMarketAccount> = [
	{
		...
		minBorrowRate: 0,
		paddingFormerFuelBoostDeposits: 0,
		paddingFormerFuelBoostBorrows: 0,
		paddingFormerFuelBoostTaker: 0,
		paddingFormerFuelBoostMaker: 0,
		paddingFormerFuelBoostInsurance: 0,
		tokenProgramFlag: 0,
		poolId: 0,
	},
	{
