...
fn amm_ref_price_decay_tail_test() {
    ...
    assert_eq!(
        offsets,
        [
            -212556, -191292, -172154, -154930, -139428, -125477, -125457, -125437, -125417, -125397, -112849, -101556, -91392, -82244,
            -74011, -66601, -59932, -53930, -48528, -43667, -39292, -35354, -31810, -28620, -25749, -23166, -20841, -18748,
            -16865, -15170, -13644, -12271, -11035, -9923, -8922, -8021, -7210, -6480, -5823, -5232, -4700, -4221,
            -3790, -3402, -3053, -2739, -2457, -2203, -1974, -1768, -1583, -1416, -1266, -1131, -1009, -900,
            -801, -712, -632, -560
        ]
    );
    assert_eq!(
        lspreads,
        [
            212668, 191404, 172266, 155042, 139540, 125589, 125569, 125549, 125529, 125509, 112961, 101668, 91504, 82356,
            74123, 66713, 60044, 54042, 48640, 43779, 39404, 35466, 31922, 28732, 25861, 23278, 20953, 18860,
            16977, 15282, 13756, 12383, 11147, 10035, 9034, 8133, 7322, 6592, 5935, 5344, 4812, 4333,
            3902, 3514, 3165, 2851, 2569, 2315, 2086, 1880, 1695, 1528, 1378, 1243, 1121, 1012,
            913, 824, 744, 672
        ]
    );
    assert_eq!(
        ...
        [
            ...
            1898, 1710, 1541, 1388, 1251, 1127, 1016, 916, 826, 745, 672, 606, 547, 494,
            446, 403, 364, 329, 297, 269, 244, 221, 200, 182, 165, 150, 137, 124,
            114, 104, 95, 87
        ]
    );
...
fn amm_ref_price_offset_decay_logic() {
    ...
    assert_eq!(
        lspreads,
        [
            726, 726, 726, 726, 726, 726, 536, 536, 536, 536, 726, 726, 726, 726, 726, 726,
            726, 726, 726, 726, 726, 726, 726, 726, 726, 726, 726, 726, 726, 726, 726, 726,
            726, 726, 726, 726, 726, 726, 726, 726, 726, 726, 719, 698, 680, 664, 649, 636,
            624, 613, 603, 594, 587, 579, 573, 567, 562, 558, 554, 550
        ]
    );
    assert_eq!(
        sspreads,
...
fn amm_negative_ref_price_offset_decay_logic() {
    ...
    assert_eq!(
        lspreads,
        [
            10316, 10106, 9896, 9686, 9476, 9266, 9246, 9226, 9206, 9186, 8976, 8766, 8556, 8346, 8136, 7926,
            7716, 7506, 7296, 7086, 6876, 6666, 6456, 6246, 6036, 5826, 5616, 5406, 5196, 4986, 4776, 4566,
            4356, 4146, 3936, 3726, 3516, 3306, 3096, 2886, 2676, 2466, 2256, 2046, 1836, 1626, 1416, 1206,
            996, 786, 576, 526, 526, 526, 526, 526, 526, 526, 526, 526, 526, 526, 526, 526,
