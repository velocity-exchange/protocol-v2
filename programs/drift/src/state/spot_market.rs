...
pub struct SpotMarket {
    ...
    pub padding_former_fuel_boost_deposits: u8,
    pub padding_former_fuel_boost_borrows: u8,
    pub padding_former_fuel_boost_taker: u8,
    pub padding_former_fuel_boost_maker: u8,
    pub padding_former_fuel_boost_insurance: u8,
...
impl Default for SpotMarket {
    fn default() -> Self {
        SpotMarket {
            ...
            min_borrow_rate: 0,
            padding_former_fuel_boost_deposits: 0,
            padding_former_fuel_boost_borrows: 0,
            padding_former_fuel_boost_taker: 0,
            padding_former_fuel_boost_maker: 0,
            padding_former_fuel_boost_insurance: 0,
